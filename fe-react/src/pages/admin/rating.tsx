...
const RatingPage = () => {
    ...
    const columns: ProColumns<IRating>[] = [
        ...
        {
            title: "KQ phân tích Comment",
            dataIndex: ["commentEmotionAnalysis"],
            hideInSearch: true,

            render: (value, record, index) => {
                let color = "gray"; // Neutral mặc định

                if (record.commentEmotionAnalysis === "Positive")
                    color = "green";
                else if (record.commentEmotionAnalysis === "Negative")
                    color = "red";

                return (
                    <span style={{ color, fontWeight: "bold" }}>
                        {record.commentEmotionAnalysis}
                    </span>
                );
            },
        },
