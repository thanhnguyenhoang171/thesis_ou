...
export const callFetchTotalPositiveComments = () => {
    return axios.get(`/api/v1/ratings/positive-comments`);
}
...
export const callFetchTotalNegativeComments = () => {
    return axios.get(`/api/v1/ratings/negative-comments`);
}
export const callFetchTotalNeutralComments = () => {
    return axios.get(`/api/v1/ratings/neutral-comments`);
}
